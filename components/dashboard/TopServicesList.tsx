    ...
    <Card className="space-y-4 rounded-3xl p-5 sm:p-6 border border-slate-100 shadow-xs h-full">
      <div className="flex items-center justify-between gap-3">
        <div className="min-w-0">
          <h3 className="text-sm sm:text-base font-extrabold text-[#0F3D91] truncate">Top Services</h3>
          <p className="text-[11px] sm:text-xs text-slate-500 font-medium mt-0.5">Most requested by guests</p>
        </div>
          ...
          return (
            <div key={item.service} className="space-y-1.5">
              <div className="flex justify-between text-xs font-bold text-slate-700 gap-2">
                ...
                <span className="font-extrabold text-[#0F3D91] shrink-0">{item.count}×</span>
              </div>

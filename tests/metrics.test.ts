  ...
  const sampleOrders: HotelOrder[] = [
    {
      id: "ORD-1001",
      guestId: "G-1",
      guest: { id: "G-1", name: "John Smith", email: "john@example.com", role: "CUSTOMER" },
      roomNumber: "204",
      service: "RoomService",
      quantity: 2,
      amount: 150000,
    ...
    },
    {
      id: "ORD-1002",
      guestId: "G-2",
      guest: { id: "G-2", name: "Sarah Johnson", email: "sarah@example.com", role: "CUSTOMER" },
      roomNumber: "312",
    ...
    },
    {
      id: "ORD-1003",
      guestId: "G-3",
      guest: { id: "G-3", name: "Michael Tan", email: "michael@example.com", role: "CUSTOMER" },
      roomNumber: "105",
      service: "Laundry",
      quantity: 3,
      amount: 120000,
